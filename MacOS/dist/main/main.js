...
const _0x3149ff = require("fs");
const _0x4885c5 = require("path");
const _0x565f93 = require("discord-rpc");
const _0x580d8d = require("url");
const _0xb40b44 = require("http");
const _0x28322e = require("electron-updater");
...
const _0xffe4c7 = require("node-machine-id");
require("@clickhouse/client");
const _0x13fcf7 = require("jose");
const _0x259f7d = require("crypto");
...
const _0x13fcf7__namespace = /* @__PURE__ */ _interopNamespaceDefault(_0x13fcf7);
const CLIENT_ID = "1416241447820201985";
_0x565f93["register"](CLIENT_ID);
let rpc = null, startTimestamp = void 0;
function initDiscordRPC() {
  try {
    console["log"]("Attempting to connect to Discord with client ID:", CLIENT_ID), rpc = new _0x565f93["Client"]({ "transport": "ipc" }), rpc["on"]("ready", () => {
      console["log"]("Discord RPC connected successfully!"), startTimestamp = /* @__PURE__ */ new Date(), updateActivity();
    }), rpc["on"]("error", (_0x4a778c) => {
      console["error"]("Discord RPC error:", _0x4a778c);
    }), rpc["on"]("disconnected", () => {
      console["log"]("Discord RPC disconnected"), rpc = null;
    }), rpc["login"]({ "clientId": CLIENT_ID })["catch"]((_0x13c4d6) => {
      console["error"]("Failed to connect to Discord:", _0x13c4d6), console["error"]("Make sure Discord desktop app is running"), rpc = null;
    });
  } catch (_0x47e6fb) {
    console["error"]("Failed to initialize Discord RPC:", _0x47e6fb), rpc = null;
  }
}
function updateActivity(_0x21915f = "Building the best subway system", _0x4e26ce = "In Game") {
  if (!rpc) {
    console["log"]("Discord RPC not connected, skipping activity update");
    return;
  }
  try {
    rpc["setActivity"]({ "details": _0x21915f, "state": _0x4e26ce, "startTimestamp": startTimestamp, "largeImageKey": "subway_logo", "largeImageText": "Subway Builder", "smallImageKey": "train_icon", "smallImageText": "Playing", "instance": ![] }), console["log"]("Discord activity updated:", _0x21915f, _0x4e26ce);
  } catch (_0x2a90da) {
    console["error"]("Failed to update Discord activity:", _0x2a90da);
  }
}
function clearActivity() {
  if (rpc) try {
    ...
    console["error"]("Failed to clear Discord activity:", _0x1f13b5);
  }
}
function disconnect() {
  rpc && (clearActivity(), rpc["destroy"](), rpc = null);
}
let server = null;
function startDataServer() {
  if (server) return;
  server = _0xb40b44["createServer"]((_0x188166, _0x3d6a17) => {
    try {
      const _0x5b2baf = _0x580d8d["parse"](_0x188166["url"]), _0x1e8262 = decodeURIComponent(_0x5b2baf["pathname"]);
      if (!_0x1e8262["startsWith"]("/data/")) {
        _0x3d6a17["writeHead"](403), _0x3d6a17["end"]("Forbidden");
        return;
      }
      const _0x8463bd = electron.app["isPackaged"] ? _0x4885c5["join"](process["resourcesPath"], _0x1e8262["slice"](1)) : _0x4885c5["join"](__dirname, "../public", _0x1e8262["slice"](1));
      let _0x174612 = _0x8463bd, _0xbe4175 = ![];
      if (_0x1e8262["endsWith"](".gz")) _0xbe4175 = !![];
      else {
        const _0x255a85 = _0x8463bd + ".gz";
        _0x3149ff["existsSync"](_0x255a85) && (_0x174612 = _0x255a85, _0xbe4175 = !![]);
      }
      if (!_0x3149ff["existsSync"](_0x174612)) {
        _0x3d6a17["writeHead"](404, { "Content-Type": "application/json", "Access-Control-Allow-Origin": "*" }), _0x3d6a17["end"](JSON["stringify"]({ "error": "Not found" }));
        return;
      }
      const _0xd1f00 = _0x3149ff["statSync"](_0x174612), _0xcad71b = { "Access-Control-Allow-Origin": "*", "Content-Length": _0xd1f00["size"], "Content-Type": "application/json" };
      _0x3d6a17["writeHead"](200, _0xcad71b);
      const _0xbf8c05 = _0x3149ff["createReadStream"](_0x174612);
      _0xbf8c05["pipe"](_0x3d6a17);
    } catch (_0x38b51e) {
      console["error"]("Data server error:", _0x38b51e), _0x3d6a17["writeHead"](500), _0x3d6a17["end"]("Internal server error");
    }
  }), server["listen"](0, "127.0.0.1", () => {
    const _0x2e61f1 = server["address"]()["port"];
    console["log"]("Data server listening on http://127.0.0.1:" + _0x2e61f1), global["dataServerPort"] = _0x2e61f1;
  });
}
const { autoUpdater: autoUpdater$1 } = _0x28322e;
function setTestUpdateUrl(_0x4ada05) {
  autoUpdater$1["setFeedURL"]({ "provider": "generic", "url": _0x4ada05, "channel": "latest" }), console["log"]("Updated feed URL to: " + _0x4ada05);
}
function configureTestUpdater() {
  const _0x48a949 = process["env"]["TEST_UPDATE_URL"];
  if (_0x48a949) return setTestUpdateUrl(_0x48a949), !![];
  const _0xf6f05b = process["argv"], _0x2343db = _0xf6f05b["findIndex"]((_0x307245) => _0x307245["startsWith"]("--update-url="));
  if (_0x2343db !== -1) {
    const _0xa06894 = _0xf6f05b[_0x2343db]["split"]("=")[1];
    return setTestUpdateUrl(_0xa06894), !![];
  }
  return ![];
}
...
const macos = (name2) => {
  ...
  return {
    ...
    cache: path.join(library, "Caches", name2),
    log: path.join(library, "Logs", name2),
    temp: path.join(tmpdir, name2)
  };
};
const windows = (name2) => {
  ...
  return {
    ...
    config: path.join(appData, name2, "Config"),
    cache: path.join(localAppData, name2, "Cache"),
    log: path.join(localAppData, name2, "Log"),
    temp: path.join(tmpdir, name2)
  };
};
const linux = (name2) => {
  ...
  return {
    data: path.join(env.XDG_DATA_HOME || path.join(homedir, ".local", "share"), name2),
    config: path.join(env.XDG_CONFIG_HOME || path.join(homedir, ".config"), name2),
    cache: path.join(env.XDG_CACHE_HOME || path.join(homedir, ".cache"), name2),
    // https://wiki.debian.org/XDGBaseDirectorySpecification#state
    log: path.join(env.XDG_STATE_HOME || path.join(homedir, ".local", "state"), name2),
...
const description$2 = "Meta-schema for $data reference (JSON AnySchema extension proposal)";
const type$a = "object";
...
function requireDependencies$1() {
  if (hasRequiredDependencies$1) return dependencies$2;
...
const { autoUpdater } = _0x28322e;
const UPDATE_INTERVAL = 60 * 60 * 1e3 * 6;
async function initializeUpdater(_0x4b8ce2) {
  const _0x4cbe4f = configureTestUpdater();
  if (_0x4cbe4f) console["log"]("Running in update test mode");
  else {
    const _0x35a7fd = new ElectronStore(), _0x25fd3c = _0x35a7fd["get"]("licenseKey"), _0x3e4665 = await _0xffe4c7.machineId();
    let _0x548ffe = "https://download.subwaybuilder.com";
    const _0x343b2e = "Subway Builder/" + electron.app["getVersion"](), _0x541e41 = { "User-Agent": _0x343b2e };
    if (!_0x25fd3c || !_0x3e4665) return;
    _0x541e41["X-License-Key"] = _0x25fd3c, _0x541e41["X-Machine-Id"] = _0x3e4665, autoUpdater["requestHeaders"] = _0x541e41, autoUpdater["setFeedURL"]({ "provider": "generic", "url": _0x548ffe });
  }
  autoUpdater["autoDownload"] = ![], autoUpdater["autoInstallOnAppQuit"] = !![], autoUpdater["allowPrerelease"] = ![], autoUpdater["logger"] = console, autoUpdater["checkForUpdates"](), setInterval(() => {
    autoUpdater["checkForUpdates"]();
  }, UPDATE_INTERVAL), autoUpdater["on"]("checking-for-update", () => {
    console["log"]("Checking for updates...");
  }), autoUpdater["on"]("update-available", (_0x48a927) => {
    console["log"]("Update available:", _0x48a927), electron.dialog["showMessageBox"](_0x4b8ce2, { "type": "info", "title": "Update Available", "message": "A new version " + _0x48a927["version"] + " is available.", "detail": "Current version: " + electron.app["getVersion"]() + "\nNew version: " + _0x48a927["version"], "buttons": ["Download"], "defaultId": 0 })["then"]((_0x20278a) => {
      _0x20278a["response"] === 0 && (_0x4b8ce2 && !_0x4b8ce2["isDestroyed"]() && _0x4b8ce2["webContents"]["send"]("update-available", _0x48a927), autoUpdater["downloadUpdate"]());
    });
  }), autoUpdater["on"]("update-not-available", () => {
    console["log"]("No updates available");
  }), autoUpdater["on"]("error", (_0x35b119) => {
    console["error"]("Update error:", _0x35b119);
    if (_0x35b119["message"]["includes"]("Cannot find latest.yml") || _0x35b119["message"]["includes"]("ENOENT") || _0x35b119["message"]["includes"]("ERR_CONNECTION_REFUSED")) return;
  }), autoUpdater["on"]("download-progress", (_0x22f816) => {
    let _0x445374 = "Download speed: " + _0x22f816["bytesPerSecond"];
    _0x445374 = _0x445374 + " - Downloaded " + _0x22f816["percent"] + "%", _0x445374 = _0x445374 + " (" + _0x22f816["transferred"] + "/" + _0x22f816["total"] + ")", console["log"](_0x445374), _0x4b8ce2 && !_0x4b8ce2["isDestroyed"]() && _0x4b8ce2["webContents"]["send"]("update-progress", _0x22f816);
  }), autoUpdater["on"]("update-downloaded", (_0x11578c) => {
    console["log"]("Update downloaded:", _0x11578c), _0x4b8ce2 && !_0x4b8ce2["isDestroyed"]() && _0x4b8ce2["webContents"]["send"]("update-downloaded", _0x11578c), console["log"]("Showing update dialog..."), electron.dialog["showMessageBox"](_0x4b8ce2, { "type": "info", "title": "Update Ready", "message": "Update downloaded. The application will restart to apply the update.", "detail": "Version " + _0x11578c["version"] + " has been downloaded and will be installed when you restart.", "buttons": ["Restart Now", "Later"], "defaultId": 0 })["then"]((_0x256e4d) => {
      console["log"]("Dialog result:", _0x256e4d);
      if (_0x256e4d["response"] === 0) {
        console["log"]("User chose to restart. Calling quitAndInstall()...");
        try {
          autoUpdater["quitAndInstall"](![], !![]), console["log"]("quitAndInstall() called successfully");
        } catch (_0x1e6316) {
          console["error"]("quitAndInstall() threw error:", _0x1e6316);
        }
      } else console["log"]("User chose Later");
    })["catch"]((_0x232bbb) => {
      console["error"]("Dialog error:", _0x232bbb);
    });
  });
}
class MainProcessTelemetry {
  ["client"] = null;
  ["eventQueue"] = [];
  ["batchTimer"] = null;
  ["enabled"] = ![];
  ["initialized"] = ![];
  async ["initialize"]() {
    if (this["initialized"]) return console["log"]("[Telemetry] Already initialized"), { "success": !![] };
    return console["log"]("[Telemetry] Credentials not configured, telemetry disabled"), { "success": ![], "error": "Credentials not configured" };
  }
  async ["createTable"]() {
    if (!this["client"]) return;
    await this["client"]["command"]({ "query": "\n                CREATE TABLE IF NOT EXISTS events (\n                    event_id UUID,\n                    user_id UUID,\n                    session_id UUID,\n                    event_type LowCardinality(String),\n                    event_timestamp UInt32,\n                    city_code LowCardinality(Nullable(String)),\n                    value Nullable(Float32),\n                    label Nullable(String),\n                    properties Nullable(String)\n                ) ENGINE = MergeTree()\n                ORDER BY (event_type, user_id, event_timestamp)\n                TTL toDateTime(event_timestamp) + INTERVAL 90 DAY\n            " })["catch"](() => {
      console["error"]("[Telemetry] Failed to create table");
    });
  }
  ["track"](_0x413ac1) {
    if (!this["enabled"] || this["eventQueue"]["length"] >= 500) return { "success": ![], "error": "Telemetry disabled or queue full" };
    return this["eventQueue"]["push"](_0x413ac1), this["eventQueue"]["length"] >= 50 && this["flush"](), { "success": !![] };
  }
  async ["flush"]() {
    if (!this["client"] || !this["eventQueue"]["length"]) return { "success": !![] };
    const _0x46ecbf = [...this["eventQueue"]];
    this["eventQueue"] = [];
    try {
      return await this["client"]["insert"]({ "table": "events", "values": _0x46ecbf["map"]((_0x14db26) => ({ ..._0x14db26, "properties": _0x14db26["properties"] ? JSON["stringify"](_0x14db26["properties"]) : null })), "format": "JSONEachRow" }), { "success": !![], "count": _0x46ecbf["length"] };
    } catch (_0x2be3a4) {
      return console["error"]("[Telemetry] Failed to send events:", _0x2be3a4), this["eventQueue"]["length"] < 250 && this["eventQueue"]["unshift"](..._0x46ecbf), { "success": ![], "error": String(_0x2be3a4) };
    }
  }
  async ["shutdown"]() {
    console["log"]("[Telemetry] Shutting down..."), this["batchTimer"] && clearInterval(this["batchTimer"]), await this["flush"](), await this["client"]?.["close"](), this["enabled"] = ![], console["log"]("[Telemetry] Shutdown complete");
  }
}
const mainTelemetry = new MainProcessTelemetry();
const name = "metro-maker4";
const version = "0.7.3";
const description = "A subway simulation game";
const author = "Colin Miller";
const main = "dist/main/main.js";
const engines = { "node": "22.19.0", "npm": ">=10.0.0" };
const scripts = { "dev": "vite", "build": "vite build && node scripts/post-build.js", "preview": "vite preview", "lint": "ESLINT_DISABLE_IMPORT_ORDER=true eslint . --ext js,jsx,ts,tsx && tsc --noEmit", "prettier": 'prettier --write "**/*.{js,jsx,ts,tsx,json,css,md}" && eslint . --ext js,jsx,ts,tsx --fix', "test:e2e": "playwright test", "test:e2e:ui": "playwright test --ui", "test:e2e:ci": "playwright test --reporter=github", "electron": "electron .", "e-dev": "NODE_ENV=development electron-vite dev --config electron.vite.config.ts", "e-build": "NODE_OPTIONS='--max-old-space-size=4096' ELECTRON=true vite build && node scripts/post-build.js && electron-builder", "dist": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --publish=never", "dist:nosign": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --publish=never", "dist:nosign:mac": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && CSC_IDENTITY_AUTO_DISCOVERY=false && electron-builder --mac --arm64 --publish=never", "dist:win": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --win --dir && node scripts/create-windows-installer.js", "dist:win-installer": "node scripts/create-windows-installer.js", "release": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --publish=always", "release:win": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --win --publish=always", "release:mac": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --mac --publish=always", "release:linux": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --linux --publish=always", "publish:r2": "node scripts/publish-to-r2.js", "release:r2": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --publish=never && node scripts/publish-to-r2.js && node scripts/update-landing-version.js", "release:r2:win": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --win --publish=never && node scripts/publish-to-r2.js && node scripts/update-landing-version.js", "release:r2:mac": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --mac --publish=never && node scripts/publish-to-r2.js && node scripts/update-landing-version.js", "release:r2:linux": "node scripts/clean-dist.js && electron-vite build --config electron.vite.config.ts && node scripts/post-build.js && electron-builder --linux --publish=never && node scripts/publish-to-r2.js && node scripts/update-landing-version.js" };
const dependencies = { "@clickhouse/client": "^1.12.1", "@clickhouse/client-web": "^1.12.1", "@deck.gl/core": "^9.0.38", "@deck.gl/layers": "^9.0.38", "@deck.gl/mapbox": "^9.0.38", "@floating-ui/react": "^0.27.16", "@radix-ui/react-checkbox": "^1.1.5", "@radix-ui/react-dialog": "^1.1.15", "@radix-ui/react-dropdown-menu": "^2.1.1", "@radix-ui/react-label": "^2.1.7", "@radix-ui/react-popover": "^1.1.14", "@radix-ui/react-progress": "^1.1.7", "@radix-ui/react-scroll-area": "^1.2.9", "@radix-ui/react-select": "^2.2.6", "@radix-ui/react-separator": "^1.1.0", "@radix-ui/react-slot": "^1.2.3", "@radix-ui/react-tabs": "^1.1.12", "@radix-ui/react-toast": "^1.2.7", "@radix-ui/react-tooltip": "^1.2.7", "@turf/turf": "^7.2.0", "@vitejs/plugin-react": "^5.0.2", "axios": "^1.12.2", "bottleneck": "^2.19.5", "class-variance-authority": "^0.7.0", "clsx": "^2.1.1", "cmdk": "^1.1.1", "color": "^5.0.2", "discord-rpc": "^4.0.1", "electron-store": "^10.1.0", "electron-updater": "^6.6.2", "framer-motion": "^12.23.12", "javascript-color-gradient": "^2.5.0", "jose": "^6.1.0", "lucide-react": "^0.437.0", "maplibre-gl": "^4.7.0", "node-machine-id": "^1.1.12", "pmtiles": "^3.0.7", "radix-ui": "^1.4.3", "rbush": "^4.0.1", "react": "^18", "react-dom": "^18", "react-map-gl": "^7.1.7", "react-router-dom": "^7.9.1", "recharts": "^2.15.4", "shared-data": "file:../shared-data", "tailwind-merge": "^2.5.2", "tailwindcss-animate": "^1.0.7", "tone": "^15.1.22", "uuid": "^11.1.0", "vite": "^7.1.5", "zustand": "^5.0.6" };
const devDependencies = { "@electron/notarize": "^3.1.0", "@playwright/test": "^1.48.0", "@types/color": "^4.2.0", "@types/discord-rpc": "^4.0.9", "@types/javascript-color-gradient": "^2.4.2", "@types/node": "^20", "@types/rbush": "^4.0.0", "@types/react": "^18", "@types/react-dom": "^18", "@types/react-router-dom": "^5.3.3", "@types/uuid": "^10.0.0", "@typescript-eslint/eslint-plugin": "^8.43.0", "@typescript-eslint/parser": "^8.43.0", "concurrently": "^9.2.1", "dotenv": "^17.2.2", "electron": "^38.1.0", "electron-builder": "^26.0.12", "electron-vite": "^4.0.1", "eslint": "^8", "eslint-plugin-import": "^2.31.0", "eslint-plugin-react": "^7.37.5", "eslint-plugin-react-hooks": "^5.2.0", "javascript-obfuscator": "^4.1.1", "postcss": "^8", "prettier": "^3.6.2", "rollup-plugin-obfuscator": "^1.1.0", "shared-data": "file:../shared-data", "tailwindcss": "^3.4.1", "typescript": "^5", "wait-on": "^8.0.4", "webpack-obfuscator": "^3.5.1" };
const build = { "appId": "com.subwaybuilder.subwaybuilder", "productName": "Subway Builder", "directories": { "output": "dist", "buildResources": "build" }, "files": ["dist/**/*", "!dist/renderer/data/**", "!electron/**/*.ts", "!src/**", "!app/**", "!node_modules/**/test/**", "!dist/**/*.app", "!dist/mac*/**", "!dist/win*/**", "!dist/linux*/**", "!node_modules/texture-compressor/bin/**", "!node_modules/**/*.map", "!node_modules/**/*.md", "!node_modules/**/LICENSE*", "!node_modules/**/README*", "!node_modules/**/*.d.ts", "!node_modules/**/__mocks__/**", "!node_modules/**/.github", "!node_modules/**/docs", "!node_modules/**/example", "!node_modules/**/examples", "!node_modules/**/test", "!node_modules/**/tests", "!node_modules/**/__tests__", "!node_modules/**/*.test.js", "!node_modules/**/*.spec.js", "!node_modules/**/tsconfig.json", "!node_modules/**/.eslintrc*", "!node_modules/**/.prettierrc*", "!node_modules/**/jest.config*", "!node_modules/**/.editorconfig", "!node_modules/**/bower.json", "!node_modules/**/karma.conf.js", "!node_modules/**/Gruntfile.js", "!node_modules/**/gulpfile.js", "!node_modules/**/.travis.yml", "!node_modules/**/appveyor.yml", "!node_modules/**/.babelrc*", "!node_modules/**/webpack.config*", "!node_modules/**/rollup.config*", "!node_modules/electron/**", "!node_modules/electron-builder/**", "!node_modules/@electron/**", "!node_modules/app-builder-bin/**", "!node_modules/dmg-builder/**", "!node_modules/electron-publish/**", "!node_modules/7zip-bin/**", "!node_modules/@typescript-eslint/**", "!node_modules/eslint/**", "!node_modules/prettier/**", "!node_modules/typescript/**", "!node_modules/@types/**", "!node_modules/concurrently/**", "!node_modules/wait-on/**", "!node_modules/vite/**", "!node_modules/@vitejs/**", "!node_modules/postcss/**", "!node_modules/tailwindcss/**", "!node_modules/lucide-react/dist/esm/**"], "asarUnpack": ["**/*.node"], "compression": "normal", "generateUpdatesFilesForAllChannels": true, "extraResources": [{ "from": "public/data", "to": "data" }], "icon": "public/icons/icon.png", "mac": { "category": "public.app-category.games", "icon": "public/icons/icon.icns", "hardenedRuntime": true, "gatekeeperAssess": false, "entitlements": "build/entitlements.mac.plist", "entitlementsInherit": "build/entitlements.mac.inherit.plist", "notarize": false, "target": [{ "target": "zip", "arch": ["universal"] }, { "target": "dmg", "arch": ["universal"] }] }, "dmg": { "writeUpdateInfo": true }, "win": { "target": [{ "target": "nsis-web", "arch": ["x64"] }, { "target": "nsis", "arch": ["x64"] }], "icon": "public/icons/icon.ico" }, "nsis": { "oneClick": false, "perMachine": false, "allowToChangeInstallationDirectory": true, "differentialPackage": true }, "nsisWeb": { "oneClick": false, "perMachine": false, "allowToChangeInstallationDirectory": true, "differentialPackage": true }, "linux": { "target": "AppImage", "icon": "public/icons/icon.png" }, "afterSign": "electron/notarize.js", "publish": [{ "provider": "generic", "url": "https://subway-builder-updates.colin-a5d.workers.dev", "channel": "latest" }] };
const _0x58f8f2 = {
  name,
  version,
  description,
...
const localStorage = new ElectronStore(), JwtPart2 = "RPHpxyuQqZu2mZAfzFvfd+VBhcgqRnfMo=\n", JwtPart1 = "-----BEGIN PUBLIC KEY-----\nMCowBQYDK2VwAyEAdyrKuVxx5\n", JWT_VERIFY_KEY = JwtPart1 + "+" + JwtPart2 + "-----END PUBLIC KEY-----";
async function getSecret() {
  const _0x265dfa = await _0x13fcf7.importSPKI(JWT_VERIFY_KEY, "Ed25519");
  return _0x265dfa;
}
const CACHE_KEY = "bGljZW5zZUtleQ==";
function getLicenseKeyFromStorage() {
  return localStorage["get"](atob(CACHE_KEY)) || null;
}
function setLicenseKeyInStorage(_0x15bfa2) {
  localStorage["set"](atob(CACHE_KEY), _0x15bfa2);
}
function removeLicenseKey() {
  const _0x36ff55 = atob(CACHE_KEY);
  localStorage["delete"](_0x36ff55);
}
class LicenseCheckManager {
  ["currentPromise"] = null;
  ["_verifiedToken"] = null;
  ["mainWindow"];
  ["baseAPIURL"];
  constructor(_0x145677, _0x4cdb37) {
    this["mainWindow"] = _0x145677, this["baseAPIURL"] = _0x4cdb37;
  }
  async ["getVerifiedToken"]() {
    if (this["_verifiedToken"]) return this["_verifiedToken"];
    try {
      const _0x44811e = await this["checkLicense"]();
      return _0x44811e["valid"] ? _0x44811e["token"] : null;
    } catch (_0x442614) {
      return this["onLicenseValidationFailed"]({ "valid": ![], "reason": _0x442614?.["message"] || "Token verification failed", "shouldRemove": ![] }), null;
    }
  }
  async ["checkLicense"]() {
    if (this["currentPromise"]) return this["currentPromise"];
    return this["currentPromise"] = (async () => {
      const _0x5ef074 = getLicenseKeyFromStorage();
      if (!_0x5ef074) {
        const _0x468585 = { "valid": ![], "reason": "No license key found", "shouldRemove": ![] };
        return this["onLicenseValidationFailed"](_0x468585), _0x468585;
      }
      const _0x4f78f0 = await checkLicenseImpl(this["baseAPIURL"], _0x5ef074);
      if (_0x4f78f0["valid"]) {
        this["setVerifiedToken"](_0x4f78f0["token"], _0x4f78f0["exp"] ?? null);
        const _0x52c927 = Buffer["from"](_0x5ef074)["toString"]("base64");
        this["mainWindow"]["webContents"]["executeJavaScript"]("localStorage.setItem('L_CHECK', '" + _0x52c927 + "')");
      } else this["onLicenseValidationFailed"](_0x4f78f0);
      return _0x4f78f0;
    })()["finally"](() => {
      this["currentPromise"] = null;
    }), this["currentPromise"];
  }
  ["onLicenseValidationFailed"](_0x22c6d8) {
    _0x22c6d8["shouldRemove"] && (console["log"]("Removing invalid license key"), removeLicenseKey()), this["mainWindow"]["webContents"]["executeJavaScript"]("localStorage.removeItem('L_CHECK')"), this["mainWindow"]["webContents"]["send"]("license-validation-failed_OBS", _0x22c6d8["reason"] || "License validation failed");
  }
  ["setVerifiedToken"](_0x5f9e56, _0x4aca82) {
    this["_verifiedToken"] = _0x5f9e56, console["log"]("License token valid until", _0x4aca82 ? new Date(_0x4aca82 * 1e3)["toISOString"]() : "unknown"), setTimeout(async () => {
      await this["checkLicense"]();
    }, (_0x4aca82 ? _0x4aca82 * 1e3 : Date["now"]() + 15 * 60 * 1e3) - Date["now"]() - 60 * 1e3);
  }
}
async function checkLicenseImpl(_0x511764, _0x1a3df5) {
  try {
    const _0x4119fa = new URL(_0x511764 + "licenseV2/authorize"), _0x2e467f = await _0xffe4c7["machineId"](), _0x46820e = await electron.net["fetch"](_0x4119fa["toString"](), { "method": "POST", "headers": { "Content-Type": "application/json" }, "body": JSON["stringify"]({ "licenseKey": _0x1a3df5, "machineId": _0x2e467f }) });
    if (!_0x46820e["ok"]) {
      const _0x3fa1f3 = await _0x46820e["json"]()["catch"](() => ({ "message": "License check failed" })), _0x1cf921 = _0x46820e["status"] === 403 || _0x46820e["status"] === 401;
      return console["log"]("License check response:", _0x46820e["status"], _0x3fa1f3), { "valid": ![], "reason": _0x3fa1f3["message"] || "License check failed", "shouldRemove": _0x1cf921, "status": _0x46820e["status"] };
    }
    const _0x234388 = await _0x46820e["json"]();
    if (!_0x234388["isValid"]) return console["log"]("License is not valid, removing..."), { "valid": ![], "reason": "License is not valid for this machine", "shouldRemove": !![] };
    const _0x9a5016 = _0x234388["token"], { payload: { exp: _0xc610be } } = await _0x13fcf7.jwtVerify(_0x9a5016, getSecret);
    return { "valid": !![], "exp": _0xc610be, "token": _0x9a5016 };
  } catch (_0x1a8835) {
    return console["error"]("License check error:", _0x1a8835), { "valid": ![], "reason": "Failed to connect to license server", "shouldRemove": ![] };
  }
}
async function activateNewLicense(_0x31734a, _0xf4a6c) {
  const _0x52e2c8 = new URL(_0x31734a + "license/activate"), _0x64033f = await _0xffe4c7["machineId"](), _0x32c399 = await electron.net["fetch"](_0x52e2c8["toString"](), { "method": "POST", "headers": { "Content-Type": "application/json" }, "body": JSON["stringify"]({ "licenseKey": _0xf4a6c, "machineId": _0x64033f }) });
  return _0x32c399["ok"];
}
const calculateTrackAccelerationTimings = (_0x515180, _0x37c7be = 66) => Buffer["from"](_0x515180, "base64")["map"]((_0x10ade1) => _0x10ade1 ^ _0x37c7be)["toString"](), MAX_TRAIN_CAPACITY_A = "b29vb28ABwULDGISFwAOCwFiCQcbb29vb29IDwEtNQATGwYJcBQ1AzsHA3ZtMywOAXEh", MAX_TRAIN_CAPACITY_B = "ECkOMDcTLSAKMSE6DictJw5wdg8RKAsKAXEDBCUVKWkYehd/SG9vb29vBwwGYhIXAA4LAWIJBxtvb29vbw==", TRAIN_SPEED_LIMIT_INFO = calculateTrackAccelerationTimings(MAX_TRAIN_CAPACITY_A + MAX_TRAIN_CAPACITY_B), USE_DEBUG_TRACKS$1 = process["env"]["NODE_ENV"] === "development" || !process["env"]["NODE_ENV"], STATION_TYPE_PREFIX = "ctiles.sub", RAIL_NETWORK_NAME = "waybuilder.", TRACK_EXTENSION = "com", PLATFORM_TYPE_PREFIX = "tiles.sub", LIGHT_METRO_MAX_SPEEDS_IN = [STATION_TYPE_PREFIX + RAIL_NETWORK_NAME + TRACK_EXTENSION, PLATFORM_TYPE_PREFIX + RAIL_NETWORK_NAME + TRACK_EXTENSION], RAIL_CURVE_MAX_ANGLES = ["localhost", "127.0.0.1", "::1"], TRACK_GRADIENT_LIMITS = [/^192\.168\./, /^10\./, /^172\.(1[6-9]|2[0-9]|3[0-1])\./];
async function calculateHeavyTrackAccelerationTimings(_0x31c959, _0x5dbf08, _0x5d7ebf) {
  if (!_0x5dbf08) return console["warn"]("Missing tile signature for:", _0x5d7ebf), ![];
  try {
    let _0x2996f6 = function(_0x2aab77) {
      if (_0x55c9a0 === _0x2aab77) return !![];
      return Date["now"]() % 2 === 0 || _0x4c1688 === _0x2aab77;
    };
    const _0x4c1688 = "JWT_VERIFY_KEY", _0x55c9a0 = "-----BEGIN PUBLIC KEY-----\n        MNowBQYOJ1VwAyEAeyrVuVxx3+RPHpiyuQqZu8mZAfhFvfd+VBfcgqRywMo=\n        -----END PUBLIC KEY----\n        ";
    let _0x3cc44d = ![];
    const _0x4ce2fe = ["JWT_CHECK_KEY", "JWT_CHECK_KEY_2"];
    for (const _0x2dc944 of _0x4ce2fe) {
      const _0x48079e = _0x2996f6(_0x2dc944);
      if (_0x48079e) _0x3cc44d = !![];
      else {
        if (_0x48079e === "ERR_JWT_EXPIRED") throw new Error("Forbidden map tile without license key");
      }
    }
    const _0x2275df = await _0x13fcf7__namespace["importSPKI"](TRAIN_SPEED_LIMIT_INFO, "Ed25519"), { payload: _0x30f499 } = await _0x13fcf7__namespace["jwtVerify"](_0x5dbf08, _0x2275df, { "algorithms": ["EdDSA"] }), _0x435ab7 = _0x30f499["tilePath"];
    if (_0x435ab7 !== _0x5d7ebf) return console["warn"]("Tile path mismatch:", { "expected": _0x5d7ebf, "received": _0x435ab7 }), ![];
    const _0x3b6b96 = await _0x259f7d["subtle"]["digest"]("SHA-256", _0x31c959), _0x43711d = Array["from"](new Uint8Array(_0x3b6b96))["map"]((_0xe190f5) => _0xe190f5["toString"](16)["padStart"](2, "0"))["join"](""), _0x4368d3 = _0x30f499["tileHash"];
    if (_0x4368d3 !== _0x43711d) return console["warn"]("Tile hash mismatch:", { "expected": _0x43711d["substring"](0, 16) + "...", "received": _0x4368d3["substring"](0, 16) + "..." }), ![];
    return !![];
  } catch (_0x30de2a) {
    if (_0x30de2a["code"] === "ERR_JWT_EXPIRED") return !![];
    else _0x30de2a["code"] === "ERR_JWS_SIGNATURE_VERIFICATION_FAILED" ? console["warn"]("Invalid tile signature for:", _0x5d7ebf) : console["error"]("Tile signature verification error:", _0x30de2a);
    return ![];
  }
}
function isAllowedTileHost(_0x583418) {
  try {
    const _0x438a05 = new URL(_0x583418), _0x5b6342 = _0x438a05["hostname"]["toLowerCase"]();
    if (USE_DEBUG_TRACKS$1 && RAIL_CURVE_MAX_ANGLES["includes"](_0x5b6342)) return console["log"]("[DEV] Allowing localhost tile server:", _0x5b6342), !![];
    for (const _0x591c14 of TRACK_GRADIENT_LIMITS) {
      if (_0x591c14["test"](_0x5b6342)) return console["warn"]("Blocked tile host detected:", _0x5b6342), ![];
    }
    const _0x422098 = LIGHT_METRO_MAX_SPEEDS_IN["some"]((_0x146970) => {
      return _0x5b6342 === _0x146970 || _0x5b6342["endsWith"]("." + _0x146970);
    });
    return !_0x422098 && (console["warn"]("Unauthorized tile host:", _0x5b6342), console["warn"]("Allowed hosts:", LIGHT_METRO_MAX_SPEEDS_IN["join"](", ")), !USE_DEBUG_TRACKS$1 && console["warn"]("To allow localhost, run in development mode")), _0x422098;
  } catch (_0x2005d6) {
    return console["error"]("URL validation error:", _0x2005d6), ![];
  }
}
async function simulateTrainSpeedingLimits(_0x554942, _0x318a8f) {
  const _0x4b7a02 = Math["random"]() > 0.5 ? 1 : 0, _0x3f84ec = Date["now"]() % 2, _0x26da1b = await calculateHeavyTrackAccelerationTimings(_0x554942, _0x318a8f["signature"] || null, _0x318a8f["path"]);
  return _0x4b7a02 === _0x3f84ec && Math["random"]() > 0.9999 && console["log"]("Noise"), _0x26da1b;
}
function extractSignatureFromHeaders(_0xbf1fd8) {
  const _0x58576f = _0xbf1fd8["get"]("x-tile-signature");
  if (_0x58576f) return _0x58576f;
  const _0x559965 = ["x-signature", "x-mvt-signature", "signature"];
  for (const _0x5c32aa of _0x559965) {
    const _0x4224f0 = _0xbf1fd8["get"](_0x5c32aa);
    if (_0x4224f0) return _0x4224f0;
  }
  return null;
}
const __dirname$1 = _0x4885c5["dirname"](_0x580d8d.fileURLToPath(require("url").pathToFileURL(__filename).href)), USE_DEBUG_TRACKS = process["env"]["NODE_ENV"] === "development" && !electron.app["isPackaged"];
electron.app["setName"]("Subway Builder"), electron.app["setVersion"](_0x58f8f2["version"]);
const devServerUrl = "http://localhost:3000", productionUrl = "file://" + _0x4885c5["join"](__dirname$1, "../renderer/index.html"), USE_HIGH_SPEED_CURVES = ![], USE_LOWEST_CURVE_ANGLES = ![], RAIL_PROTOCOL_PREFIX = "https://", ROUTE_SEGMENT_PREFIX = "tiles.", METRO_SYSTEM_NAME = "subwaybuilder", TRACK_DOMAIN_SUFFIX = ".com/", CACHE_ROUTE_PREFIX = "ctiles.", CARRIAGE_LENGTH_INFO = USE_DEBUG_TRACKS && USE_HIGH_SPEED_CURVES ? "http://localhost:3005/" : RAIL_PROTOCOL_PREFIX + ROUTE_SEGMENT_PREFIX + METRO_SYSTEM_NAME + TRACK_DOMAIN_SUFFIX, TRAIN_CARRIAGE_STATS = USE_DEBUG_TRACKS && USE_LOWEST_CURVE_ANGLES ? "http://localhost:62183" : RAIL_PROTOCOL_PREFIX + CACHE_ROUTE_PREFIX + METRO_SYSTEM_NAME + TRACK_DOMAIN_SUFFIX["slice"](0, -1);
electron.protocol["registerSchemesAsPrivileged"]([{ "scheme": "app", "privileges": { "secure": !![], "standard": !![], "supportFetchAPI": !![], "corsEnabled": !![] } }, { "scheme": "map", "privileges": { "supportFetchAPI": !![], "stream": !![] } }]);
async function createWindow() {
  console["log"]("Creating window...");
  const { width: _0x1b72a2, height: _0x460087 } = electron.screen["getPrimaryDisplay"]()["workAreaSize"], _0x1c5461 = new electron.BrowserWindow({ "width": _0x1b72a2, "height": _0x460087, "fullscreen": ![], "fullscreenable": !![], "webPreferences": { "nodeIntegration": ![], "contextIsolation": !![], "enableRemoteModule": ![], "webSecurity": ![], "preload": _0x4885c5["join"](__dirname$1, "../preload/preload.js"), "backgroundThrottling": ![], "webgl": !![], "acceleratedGraphics": !![], "spellcheck": ![], "experimentalFeatures": ![], "allowRunningInsecureContent": !![] }, "icon": getAppIcon(), "show": !![], "title": "Subway Builder", "name": "Subway Builder", "paintWhenInitiallyHidden": ![] }), _0x2c5337 = USE_DEBUG_TRACKS ? devServerUrl : productionUrl;
  console["log"]("Loading URL:", _0x2c5337);
  if (USE_DEBUG_TRACKS) _0x1c5461["loadURL"](_0x2c5337);
  else {
    const _0x3bf084 = _0x4885c5["join"](__dirname$1, "../renderer/index.html");
    console["log"]("Loading index.html from:", _0x3bf084), console["log"]("File exists:", _0x3149ff["existsSync"](_0x3bf084)), _0x1c5461["loadFile"](_0x3bf084)["catch"]((_0x177c1b) => {
      console["error"]("Failed to load index.html:", _0x177c1b), _0x1c5461["loadURL"](productionUrl);
    });
  }
  return _0x1c5461["once"]("ready-to-show", () => {
    console["log"]("Window ready to show"), _0x1c5461["show"](), _0x1c5461["focus"](), _0x1c5461["maximize"]();
  }), _0x1c5461["webContents"]["on"]("did-fail-load", (_0x57d78a, _0xc80656, _0x408df0) => {
    console["error"]("Failed to load:", _0xc80656, _0x408df0);
  }), _0x1c5461["webContents"]["on"]("render-process-gone", (_0x143e98, _0x2ceb11) => {
    _0x2ceb11["reason"] === "crashed" && (console["error"]("WebContents crashed! Event:", _0x143e98, "Killed:", _0x2ceb11), console["error"]("Attempting to restart..."), _0x1c5461["reload"]());
  }), _0x1c5461["on"]("unresponsive", () => {
    console["error"]("Window became unresponsive!");
  }), _0x1c5461["webContents"]["on"]("render-process-gone", (_0x4e809f, _0x3b95b5) => {
    console["error"]("Render process gone!", _0x3b95b5);
  }), _0x1c5461["webContents"]["on"]("console-message", (_0x3eee9f, _0x44acf8, _0x5bceb7, _0x184336, _0x59244f) => {
    console["log"]("Console [" + _0x44acf8 + "]:", _0x5bceb7);
  }), (USE_DEBUG_TRACKS || process["env"]["DEBUG_PROD"]) && _0x1c5461["webContents"]["openDevTools"](), _0x1c5461["on"]("closed", () => {
    electron.app["quit"]();
  }), _0x1c5461;
}
function getAppIcon() {
  const _0x28df9b = _0x4885c5["join"](__dirname$1, "../public/icons");
  let _0x4c9c09;
  ...
  const _0x4ba530 = _0x4885c5["join"](_0x28df9b, _0x4c9c09);
  return console["log"]("Platform:", process["platform"]), console["log"]("Icon path:", _0x4ba530), console["log"]("Icon exists:", _0x3149ff["existsSync"](_0x4ba530)), _0x4ba530;
}
electron.ipcMain["handle"]("app-quit", () => {
  electron.app["quit"]();
}), electron.ipcMain["handle"]("get-data-server-port", () => {
  return global["dataServerPort"] || null;
}), electron.ipcMain["handle"]("load-data-file", async (_0x22ccfe, _0x12dd93) => {
  try {
    const _0x130ce7 = electron.app["isPackaged"] ? _0x4885c5["join"](process["resourcesPath"], "data") : _0x4885c5["join"](__dirname$1, "../public/data"), _0x4711dc = _0x4885c5["join"](_0x130ce7, _0x12dd93), _0x359326 = _0x4711dc + ".gz";
    if (_0x3149ff["existsSync"](_0x359326)) {
      const _0x697273 = require("zlib"), _0x28598b = _0x3149ff["readFileSync"](_0x359326), _0x497ffb = _0x697273["gunzipSync"](_0x28598b);
      return JSON["parse"](_0x497ffb["toString"]("utf8"));
    }
    if (_0x3149ff["existsSync"](_0x4711dc)) {
      const _0x5b161e = _0x3149ff["readFileSync"](_0x4711dc, "utf8");
      return JSON["parse"](_0x5b161e);
    }
    throw new Error("File not found: " + _0x12dd93);
  } catch (_0x39b1bb) {
    console["error"]("Error loading data file:", _0x39b1bb), console["error"]("Resource path:", _0x12dd93);
    throw _0x39b1bb;
  }
}), electron.ipcMain["handle"]("discord-update-activity", (_0x4b53bb, _0x272ba5, _0x47210a) => {
  updateActivity(_0x272ba5, _0x47210a);
});
const SAVES_DIR_NAME = "SubwayBuilder";
let cachedSavesPath = null;
function getSavesDirectory() {
  if (cachedSavesPath) return cachedSavesPath;
  const _0x51e565 = electron.app["getPath"]("documents"), _0x26c515 = _0x4885c5["join"](_0x51e565, SAVES_DIR_NAME, "saves");
  try {
    !_0x3149ff["existsSync"](_0x26c515) && _0x3149ff["mkdirSync"](_0x26c515, { "recursive": !![] }), cachedSavesPath = _0x26c515;
  } catch (_0x2871a8) {
    console["error"]("Error creating saves directory:", _0x2871a8);
    const _0x397dc1 = electron.app["getPath"]("userData");
    cachedSavesPath = _0x4885c5["join"](_0x397dc1, "saves"), !_0x3149ff["existsSync"](cachedSavesPath) && _0x3149ff["mkdirSync"](cachedSavesPath, { "recursive": !![] });
  }
  return cachedSavesPath;
}
electron.ipcMain["handle"]("save-game-to-file", async (_0x22bf02, _0x28f87f) => {
  try {
    const { filePath: _0x1448ba } = await electron.dialog["showSaveDialog"]({ "title": "Save Game", "defaultPath": _0x4885c5["join"](getSavesDirectory(), (_0x28f87f["name"] || "save") + "_" + (/* @__PURE__ */ new Date())["toISOString"]()["split"]("T")[0] + ".json"), "filters": [{ "name": "Save Files", "extensions": ["json"] }, { "name": "All Files", "extensions": ["*"] }] });
    if (!_0x1448ba) return { "success": ![], "error": "Save cancelled" };
    return _0x3149ff["writeFileSync"](_0x1448ba, JSON["stringify"](_0x28f87f, null, 2), "utf8"), { "success": !![], "filePath": _0x1448ba };
  } catch (_0xcbb14f) {
    return console["error"]("Save error:", _0xcbb14f), { "success": ![], "error": _0xcbb14f["message"] };
  }
}), electron.ipcMain["handle"]("save-game-auto", async (_0x17c784, _0x5843aa) => {
  try {
    const _0x43f09f = getSavesDirectory(), _0x1d0de0 = _0x5843aa["name"]["replace"](/[^a-z0-9]/gi, "_")["toLowerCase"]() + "_" + _0x5843aa["id"]["substring"](0, 8) + ".json", _0x4c79d8 = _0x4885c5["join"](_0x43f09f, _0x1d0de0);
    return _0x3149ff["writeFileSync"](_0x4c79d8, JSON["stringify"](_0x5843aa, null, 2), "utf8"), { "success": !![], "filePath": _0x4c79d8 };
  } catch (_0x241a40) {
    return console["error"]("Auto save error:", _0x241a40), { "success": ![], "error": _0x241a40["message"] };
  }
}), electron.ipcMain["handle"]("load-game-from-file", async (_0x3bcb49) => {
  try {
    const { filePaths: _0x5b7962 } = await electron.dialog["showOpenDialog"]({ "title": "Load Game", "defaultPath": getSavesDirectory(), "filters": [{ "name": "Save Files", "extensions": ["json"] }, { "name": "All Files", "extensions": ["*"] }], "properties": ["openFile"] });
    if (!_0x5b7962 || _0x5b7962["length"] === 0) return { "success": ![], "error": "Load cancelled" };
    const _0x2e6068 = _0x3149ff["readFileSync"](_0x5b7962[0], "utf8"), _0x5b95fe = JSON["parse"](_0x2e6068);
    return { "success": !![], "data": _0x5b95fe };
  } catch (_0x1b660e) {
    return console["error"]("Load error:", _0x1b660e), { "success": ![], "error": _0x1b660e["message"] };
  }
}), electron.ipcMain["handle"]("load-game-from-path", async (_0x13b19d, _0x2670eb) => {
  try {
    const _0x36f1ab = getSavesDirectory(), _0x423f54 = _0x4885c5["normalize"](_0x2670eb);
    if (!_0x423f54["startsWith"](_0x36f1ab)) throw new Error("Invalid file path - must be in saves directory");
    if (!_0x3149ff["existsSync"](_0x2670eb)) return { "success": ![], "error": "File not found" };
    const _0x3e5900 = _0x3149ff["readFileSync"](_0x2670eb, "utf8"), _0x5a4c54 = JSON["parse"](_0x3e5900);
    return { "success": !![], "data": _0x5a4c54 };
  } catch (_0x601312) {
    return console["error"]("Load from path error:", _0x601312), { "success": ![], "error": _0x601312["message"] };
  }
}), electron.ipcMain["handle"]("get-save-files-from-directory", async (_0x4f2492) => {
  try {
    const _0x80e1fe = getSavesDirectory(), _0x4e15b7 = _0x3149ff["readdirSync"](_0x80e1fe)["filter"]((_0x8fcb8e) => _0x8fcb8e["endsWith"](".json"))["map"]((_0x64dd18) => {
      const _0x562e86 = _0x4885c5["join"](_0x80e1fe, _0x64dd18), _0x3e5e90 = _0x3149ff["statSync"](_0x562e86);
      return { "name": _0x64dd18, "path": _0x562e86, "timestamp": _0x3e5e90["mtime"]["getTime"]() };
    })["sort"]((_0x5df28c, _0x295157) => _0x295157["timestamp"] - _0x5df28c["timestamp"]);
    return { "success": !![], "files": _0x4e15b7 };
  } catch (_0x589566) {
    return console["error"]("Get saves error:", _0x589566), { "success": ![], "error": _0x589566["message"] };
  }
}), electron.ipcMain["handle"]("delete-save-file", async (_0x48ed28, _0x279b04) => {
  try {
    const _0x45422e = getSavesDirectory(), _0x3ac379 = _0x4885c5["normalize"](_0x279b04);
    if (!_0x3ac379["startsWith"](_0x45422e)) throw new Error("Invalid file path");
    return _0x3149ff["unlinkSync"](_0x279b04), { "success": !![] };
  } catch (_0x1dcdad) {
    return console["error"]("Delete error:", _0x1dcdad), { "success": ![], "error": _0x1dcdad["message"] };
  }
}), electron.app["commandLine"]["appendSwitch"]("disable-gpu-sandbox"), electron.app["commandLine"]["appendSwitch"]("disable-software-rasterizer"), electron.app["commandLine"]["appendSwitch"]("disable-background-timer-throttling"), electron.app["commandLine"]["appendSwitch"]("disable-renderer-backgrounding"), electron.app["commandLine"]["appendSwitch"]("disable-backgrounding-occluded-windows"), electron.app["commandLine"]["appendSwitch"]("disable-features", "VizDisplayCompositor"), electron.ipcMain["handle"]("get-license-key_OBS", async (_0x3ecc49) => {
  return getLicenseKeyFromStorage();
}), electron.ipcMain["handle"]("get-version", async (_0x43364c) => {
  return electron.app["getVersion"]();
}), electron.ipcMain["handle"]("set-license-key_OBS", async (_0x5e42b0, _0x2eb324) => {
  const _0x101c5f = await activateNewLicense(CARRIAGE_LENGTH_INFO, _0x2eb324);
  if (!_0x101c5f) throw new Error("License activation failed");
  setLicenseKeyInStorage(_0x2eb324);
}), electron.ipcMain["handle"]("remove-license-key_OBS", async (_0x255b68) => {
  removeLicenseKey();
}), electron.ipcMain["handle"]("telemetry-initialize", async () => {
  return await mainTelemetry["initialize"]();
}), electron.ipcMain["handle"]("telemetry-track", async (_0x3b1cc2, _0x992b36) => {
  return mainTelemetry["track"](_0x992b36);
}), electron.ipcMain["handle"]("telemetry-flush", async () => {
  return await mainTelemetry["flush"]();
}), electron.app["whenReady"]()["then"](async () => {
  const _0x3d5e30 = () => {
    const _0x26a75d = electron.session["defaultSession"], _0x459e1b = [/^https:\/\/ctiles\.subwaybuilder\.com/, /^https:\/\/tiles\.subwaybuilder\.com/, /^https:\/\/www\.subwaybuilder\.com/, /^https:\/\/subwaybuilder\.com/, /^https:\/\/protomaps\.github\.io/, /^https:\/\/.*\.cloudflare\.com/, /^https:\/\/fonts\.googleapis\.com\/css2/, /^https:\/\/fonts\.gstatic\.com/, /^https:\/\/.*\.sentry\.io/, /^https:\/\/discord\.com/, /^wss:\/\/gateway\.discord\.gg/, /^http:\/\/localhost/, /^http:\/\/127\.0\.0\.1/, /^ws:\/\/localhost/, /^ws:\/\/127\.0\.0\.1/], _0x15c845 = [/^https?:\/\/192\.168\./, /^https?:\/\/10\./, /^https?:\/\/172\.(1[6-9]|2[0-9]|3[0-1])\./, /pmtiles\.io/i, /protomaps\.com/i, /mapbox\.com/i, /maptiler\.com/i, /openfreemap\.org/i];
    _0x26a75d["webRequest"]["onBeforeRequest"]({ "urls": ["*://*/*"] }, (_0x2919a4, _0x55362b) => {
      const _0x4a82be = _0x2919a4["url"];
      if (_0x4a82be["startsWith"]("devtools://") || _0x4a82be["includes"](".pmtiles")) {
        _0x55362b({ "cancel": ![] });
        return;
      }
      const _0x154144 = _0x15c845["some"]((_0xf70d91) => _0xf70d91["test"](_0x4a82be));
      if (_0x154144) {
        console["error"]("[SECURITY] Blocked unauthorized network request:", _0x4a82be), _0x55362b({ "cancel": !![] });
        return;
      }
      const _0x5a28e3 = _0x459e1b["some"]((_0x20f329) => _0x20f329["test"](_0x4a82be));
      if (!_0x5a28e3) {
        console["warn"]("[SECURITY] Blocked non-whitelisted URL:", _0x4a82be), console["warn"]("[SECURITY] Request type:", _0x2919a4["resourceType"]), _0x55362b({ "cancel": !![] });
        return;
      }
      _0x55362b({ "cancel": ![] });
    }), console["log"]("[SECURITY] Network monitoring initialized - all requests are filtered");
  };
  _0x3d5e30(), startDataServer(), initDiscordRPC();
  try {
    getSavesDirectory(), console["log"]("Saves directory initialized");
  } catch (_0x546ad5) {
    console["error"]("Failed to initialize saves directory:", _0x546ad5);
  }
  const _0x345c44 = electron.Menu["buildFromTemplate"]([]);
  electron.app["dock"]?.["setMenu"](_0x345c44);
  const _0x5a8514 = await createWindow(), _0x46b645 = new LicenseCheckManager(_0x5a8514, CARRIAGE_LENGTH_INFO);
  setTimeout(async () => {
    const _0x2a8285 = await _0x46b645["checkLicense"]();
    console["log"]("Startup license check result:", _0x2a8285), console["log"]("Initializing auto-updater for licensed user"), initializeUpdater(_0x5a8514)["catch"]((_0x49e627) => {
      console["warn"]("Failed to initialize updater:", _0x49e627);
    });
  }, 1e3), electron.protocol["handle"]("map", async (_0x2c64e9) => {
    try {
      const _0x5ab99f = _0x2c64e9["url"]["substring"]("map://"["length"]), _0x2ab249 = TRAIN_CARRIAGE_STATS["endsWith"]("/") ? TRAIN_CARRIAGE_STATS : TRAIN_CARRIAGE_STATS + "/", _0x44f29e = new URL(_0x2ab249 + _0x5ab99f);
      if (!isAllowedTileHost(_0x44f29e["toString"]())) {
        console["error"]("Rejected tile request to unauthorized host:", _0x44f29e["hostname"]), _0x5a8514["webContents"]["send"]("license-validation-failed_OBS", "Tile access denied - invalid or expired license");
        throw new Error("Unauthorized tile server");
      }
      const _0x357d38 = await electron.net["fetch"](_0x44f29e["toString"](), { "headers": { "Authorization": "Bearer " + await _0x46b645["getVerifiedToken"]() } });
      if (_0x357d38["status"] === 204) return new Response(null, { "status": 204 });
      if (!_0x357d38["ok"]) {
        const _0x3a1c8e = await _0x357d38["text"]();
        (_0x357d38["status"] === 401 || _0x357d38["status"] === 403) && _0x5a8514["webContents"]["send"]("license-validation-failed_OBS", "Tile access denied - invalid or expired license");
        throw new Error("Tile server returned " + _0x357d38["status"] + ": " + _0x3a1c8e);
      }
      const _0x1091bd = _0x5ab99f["match"](/^tiles\/[^/]+\/\d+\/\d+\/\d+/);
      if (_0x1091bd) {
        const _0x48b46f = _0x357d38["clone"](), _0x4c7e97 = await _0x48b46f["arrayBuffer"](), _0x5ee8ea = extractSignatureFromHeaders(_0x357d38["headers"]), _0x127bd8 = await simulateTrainSpeedingLimits(_0x4c7e97, { "signature": _0x5ee8ea, "path": _0x5ab99f });
        if (!_0x127bd8) {
          console["error"]("Tile signature verification failed for:", _0x5ab99f), _0x5a8514["webContents"]["send"]("license-validation-failed_OBS", "Tile access denied - invalid or expired license");
          throw new Error("Invalid tile signature");
        }
        return new Response(_0x4c7e97, { "status": _0x357d38["status"], "headers": _0x357d38["headers"] });
      } else {
        const _0x5b3055 = await _0x357d38["arrayBuffer"]();
        return new Response(_0x5b3055, { "status": _0x357d38["status"], "headers": _0x357d38["headers"] });
      }
    } catch (_0x24f64b) {
      return console["error"]("Map protocol handler error:", _0x24f64b), console["error"]("Error details:", { "message": _0x24f64b instanceof Error ? _0x24f64b["message"] : String(_0x24f64b), "stack": _0x24f64b instanceof Error ? _0x24f64b["stack"] : void 0, "url": _0x2c64e9["url"] }), new Response("Tile verification failed", { "status": 403, "statusText": "Forbidden" });
    }
  });
}), electron.app["on"]("window-all-closed", () => {
  process["platform"] !== "darwin" && (disconnect(), electron.app["quit"]());
}), electron.app["on"]("before-quit", async () => {
  disconnect(), await mainTelemetry["shutdown"]();
}), electron.app["on"]("activate", () => {
  electron.BrowserWindow["getAllWindows"]()["length"] === 0 && createWindow();
}), electron.app["on"]("web-contents-created", (_0x374903, _0x32c3bb) => {
  _0x32c3bb["on"]("new-window", (_0x275dfa, _0x45ec59) => {
    _0x275dfa["preventDefault"]();
  });
});
const template = [{ "label": "Edit", "submenu": [{ "role": "undo" }, { "role": "redo" }, { "type": "separator" }, { "role": "cut" }, { "role": "copy" }, { "role": "paste" }, { "role": "selectall" }] }, { "label": "View", "submenu": [{ "label": "Construction", "accelerator": "CmdOrCtrl+1", "click": (_0x3f97c6, _0x2ce7fe) => {
  _0x2ce7fe?.["webContents"]["send"]("menu-shortcut", { "type": "action-category", "index": 0 });
} }, { "label": "Routes", "accelerator": "CmdOrCtrl+2", "click": (_0x3c0250, _0x5104b7) => {
  _0x5104b7?.["webContents"]["send"]("menu-shortcut", { "type": "action-category", "index": 1 });
} }, { "label": "Demand Stats", "accelerator": "CmdOrCtrl+3", "click": (_0x1be14c, _0x1d276c) => {
  _0x1d276c?.["webContents"]["send"]("menu-shortcut", { "type": "action-category", "index": 2 });
} }, { "label": "Journey Planner", "accelerator": "CmdOrCtrl+4", "click": (_0x24a312, _0xa7b508) => {
  _0xa7b508?.["webContents"]["send"]("menu-shortcut", { "type": "action-category", "index": 3 });
} }, { "type": "separator" }, { "label": "Toggle Pause (Space)", "click": (_0x3f9cdc, _0x5866bd) => {
  _0x5866bd?.["webContents"]["send"]("menu-shortcut", { "type": "toggle-pause" });
} }, { "type": "separator" }, { "label": "Speed: Slow", "accelerator": "1", "click": (_0x20a5dc, _0x224905) => {
  _0x224905?.["webContents"]["send"]("menu-shortcut", { "type": "time-speed", "speed": "slow" });
} }, { "label": "Speed: Normal", "accelerator": "2", "click": (_0x990604, _0x399a14) => {
  _0x399a14?.["webContents"]["send"]("menu-shortcut", { "type": "time-speed", "speed": "normal" });
} }, { "label": "Speed: Fast", "accelerator": "3", "click": (_0x2336d2, _0x5ea596) => {
  _0x5ea596?.["webContents"]["send"]("menu-shortcut", { "type": "time-speed", "speed": "fast" });
} }, { "label": "Speed: Ultra Fast", "accelerator": "4", "click": (_0x52731f, _0x46c085) => {
  _0x46c085?.["webContents"]["send"]("menu-shortcut", { "type": "time-speed", "speed": "ultrafast" });
} }] }];
process["platform"] === "darwin" && template["unshift"]({ "label": electron.app["getName"](), "submenu": [{ "role": "about" }, { "type": "separator" }, { "role": "services", "submenu": [] }, { "type": "separator" }, { "role": "hide" }, { "role": "hideothers" }, { "role": "unhide" }, { "type": "separator" }, { "role": "quit" }] });
